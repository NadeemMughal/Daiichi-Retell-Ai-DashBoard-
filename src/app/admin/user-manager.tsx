...
export function UserManager({ users, tenants }: { users: User[]; tenants: Tenant[] }) {
  ...
  return <article id="client-users" className="glass mt-5 scroll-mt-6 rounded-2xl p-4 sm:p-6">
    ...
    {(adding || editing) && <form key={editing?.userId ?? "new-user"} onSubmit={submit} className="mt-5 grid gap-3 rounded-2xl border border-[#173f3310] bg-white/70 p-5 md:grid-cols-2 xl:grid-cols-3">
